    ...
    <div class=" max-w-screen-xl mx-auto p-4 service-section ">
        <div class="flex justify-between">
            ...
            <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                class="px-4 py-2 text-sm rounded-full font-bold text-black border-2 border-red bg-blue-200 transition-all ease-in-out duration-300 hover:bg-transparent hover:text-red"
                type="button">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form method="POST" action=" {{ route('utilisateur') }} " class="p-4 md:p-5"
                            ...
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2">
                                    <label for=""
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Conseils</label>
